...
\begin{tabular}{p{15mm}p{10cm}}
    ...
    Style: & TU Delft Report Style, with modifications by Daan Zwaneveld and Maxim Michielsen
\end{tabular}
...
\begin{tikzpicture}[remember picture, overlay]
    \node[above=10mm] at (current page.south) {%
        \includegraphics{figures/cover/logo-black}
    };
\end{tikzpicture}
